...
const FAQ = [
  ...
  // การจ่ายเงิน — เพิ่ม 22 ส.ค. 2569 หลังเจอแชทจริงที่ต้องตอบมือ ลูกค้าถามว่า
  // "my only bank account is Wise" แล้วตามด้วย "is there anyway I can be paid
  // in cash" ทั้งสองคำถามไม่มีข้อเท็จจริงรองรับในระบบเลย มีแต่บรรทัดที่บอกว่า
  // จ่าย "เมื่อไหร่" ไม่เคยบอกว่า "ด้วยอะไร"
  { c: "การจ่ายเงิน", q: "จ่ายเงินยังไง ได้เงินตอนไหน", a: "โอนเข้าบัญชีธนาคารเท่านั้น ไม่มีการจ่ายเป็นเงินสดทุกช่องทาง (Rider รับถึงบ้าน / มาที่สาขา / ส่งพัสดุ Mail-in) โอนเต็มจำนวนทันทีหลังตรวจสภาพเสร็จและตกลงราคา ภายในไม่กี่นาที ไม่มีค่าธรรมเนียม" },
  { c: "การจ่ายเงิน", q: "จ่ายเงินสดได้ไหม ขอรับเป็นเงินสด รับเงินสด", a: "ไม่ได้ทุกกรณี ทุกช่องทางจ่ายด้วยการโอนเข้าบัญชีอย่างเดียว รวมถึงตอน Rider ไปรับเครื่องถึงบ้านด้วย (ไรเดอร์ไม่ได้ถือเงินสดไป)" },
  { c: "การจ่ายเงิน", q: "ใช้บัญชีต่างประเทศ Wise PayPal ได้ไหม", a: "ไม่ได้ รับโอนเข้าบัญชีธนาคารในประเทศไทยเท่านั้น ไม่รองรับบัญชีต่างประเทศ Wise PayPal หรือกระเป๋าเงินออนไลน์ต่างประเทศ ถ้าไม่มีบัญชีธนาคารไทย ยังรับซื้อให้ไม่ได้" },
...
const OFFICIAL_FAQ_LINES = [
  ...
  `- ช่องทางการจ่ายเงิน (ห้ามตอบกำกวม): "โอนเข้าบัญชีธนาคารในประเทศไทยเท่านั้น" — ไม่มีจ่ายเงินสดทุกช่องทาง รวมถึงตอนไรเดอร์ไปรับเครื่องถึงบ้าน (ไรเดอร์ไม่ได้ถือเงินสดไป) และไม่รับบัญชีต่างประเทศ Wise PayPal หรือกระเป๋าเงินออนไลน์ต่างประเทศ. ลูกค้าที่ไม่มีบัญชีธนาคารไทย = ยังรับซื้อให้ไม่ได้ ให้บอกตรงๆ อย่างสุภาพ ห้ามเสนอทางออกที่ร้านไม่มี`,
