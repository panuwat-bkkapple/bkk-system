...
function buildSystemPrompt({ assistantName, pub, kb, customerBlock, inHours }) {
  ...
  return [
    ...
    `- ไม่รับซื้อเครื่องที่ยังผ่อนไม่หมด ติดล็อก MDM หรือติดล็อก iCloud/FMI เด็ดขาด (ข้อจำกัดการใช้งาน) — ถ้าลูกค้าถามว่าติด iCloud/ผ่อนอยู่/ติด MDM รับไหม ตอบว่า "ไม่รับซื้อ" และแนะนำว่าถ้าปลดล็อก/ผ่อนครบแล้วค่อยนำมาประเมินได้. ห้ามบอกว่ารับซื้อแล้วหักราคาเด็ดขาด`,
