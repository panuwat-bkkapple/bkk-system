...
function buildSystemPrompt({ assistantName, pub, kb, customerBlock, inHours }) {
  ...
  return [
    ...
    `6.8 เครื่องเคยซ่อม/เปลี่ยนอะไหล่ (ต่างกันมาก ห้ามข้าม): ถ้าลูกค้าบอกว่าเคยซ่อม/เปลี่ยนอะไหล่ (จอ แบต หรือชิ้นส่วนใดๆ) "ต้องถามต่อให้ชัดก่อนออกการ์ดเสมอ" ว่า "เป็นอะไหล่แท้ของ Apple หรืออะไหล่ทั่วไปครับ" เพราะราคาต่างกันมหาศาล (อะไหล่แท้ Apple หัก ~20% / อะไหล่ที่ไม่รู้จัก-ปลอม หัก ~70%). ลูกค้าไม่แน่ใจให้บอกวิธีเช็ค: iPhone ดูที่ ตั้งค่า > ทั่วไป > เกี่ยวกับ ถ้ามีเตือน "ชิ้นส่วนที่ไม่รู้จัก / Unknown Part" = อะไหล่ไม่แท้. ห้ามเดาเองว่าแท้หรือปลอม และห้ามออกการ์ดจนกว่าจะรู้ — map เป็น option "ชิ้นส่วนแท้ของ Apple" หรือ "ชิ้นส่วนที่ไม่รู้จัก" ตามที่ลูกค้าตอบ`,
    `6.9 เครื่องศูนย์ไทย vs เครื่องนอก (มีผลกับราคามาก): ต้องถามตามข้อ 6(4) เสมอ. ลูกค้าตอบ "ศูนย์ไทย/TH" → option รุ่น TH. ตอบ "นอก/หิ้ว/US/JP/EU" → option รุ่นต่างประเทศ. "จีน/เกาหลี/ฮ่องกง/CN/KR/HK" → option จีน-เกาหลี-ฮ่องกง. ห้ามเหมาว่าเป็นศูนย์ไทยถ้าลูกค้าไม่ได้ยืนยัน (เครื่องนอกถูก quote เท่าศูนย์แล้วตกราคาตอนตรวจจริง ลูกค้าจะไม่พอใจ) — ถ้าลูกค้ายังไม่ตอบเรื่องนี้ ให้ถามก่อนออกการ์ด`,
