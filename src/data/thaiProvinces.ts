// Thai provinces (kongvut canonical IDs) — mirror of bkk-frontend-next
// public/postal/provinces.json. Used by the rider-fee promotion admin to
// target promotions by province. IDs MUST match the job.provinceId written
// at checkout (same dataset) or eligibility will never match.
export interface ThaiProvince { id: number; name_th: string; name_en: string; }
