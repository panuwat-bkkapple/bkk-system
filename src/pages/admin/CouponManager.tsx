                                ...
                                <div className="bg-white p-6 rounded-3xl shadow-sm border border-slate-200 space-y-5">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-[10px] font-bold text-slate-400 mt-1.5 leading-relaxed">
                                            "ผูกกับเครื่อง" = คูปองเกาะไปกับตัวเครื่อง ลูกค้าที่ขาย MacBook + iPhone พร้อมกันได้ทั้งสองใบ
                                            และ<strong className="text-amber-600">แคมเปญใบเดียวกันเกาะได้ทุกเครื่องที่เข้าเงื่อนไข</strong> —
                                            ขาย MacBook สองเครื่องใต้แคมเปญเดียวกันก็ได้สองเท่า เท่ากับแยกขายสองออเดอร์
                                            ตัวคุมงบคือโควตา (Max) ด้านล่าง ซึ่งถูกตัดหนึ่งครั้งต่อหนึ่งเครื่องที่ได้คูปอง
                                        </p>
                                    </div>
