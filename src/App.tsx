          ...
          <>
            ...
            <Route element={<AdminLayout currentUser={currentUser} onLogout={handleLogout} />}>
              ...
              <Route path="/hr/shifts" element={currentUser?.role === 'CEO' || currentUser?.role === 'HR' ? <Shifts /> : <Navigate to="/" replace />} />
                ...
                <Route path="/audit-log" element={currentUser?.role === 'CEO' ? <AuditLog /> : <Navigate to="/" replace />} />
                ...
                <Route path="/settings/receipt" element={currentUser?.role === 'CEO' ? <ReceiptSettings /> : <Navigate to="/" replace />} />
