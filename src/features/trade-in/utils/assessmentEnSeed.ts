...
export const ASSESSMENT_EN_SEED: Record<string, string> = {
  ...
  'อุปกรณ์ที่ให้มาพร้อมเครื่อง': 'What is included with the device',
  'กล่องตรงเครื่อง อุปกรณ์แท้ครบ': 'Matching box with complete genuine accessories',
  'มีเครื่องและสายชาร์จ แต่ไม่มีกล่อง': 'Device and charging cable, no box',
  'มีเฉพาะตัวเครื่อง ไม่มีสายชาร์จและกล่อง': 'Device only, no cable or box',
  ...
  'เครื่องศูนย์ไทย รหัสรุ่นลงท้าย ZP/A': 'Thai model — model number ends in ZP/A',
  'เครื่องนอก (LL / J / CH / อื่นๆ)': 'International model (LL / J / CH / other)',
  'เครื่องนอก (ZP / ZA / อื่นๆ)': 'International model (ZP / ZA / other)',
  'เครื่องนอกเอเชีย สเปกโกลบอล (SG / MY / VN / อื่นๆ)': 'Asian international model, global spec (SG / MY / VN / other)',
  'เครื่องนอก สเปกโกลบอล (ZP / MY / LL / อื่นๆ)': 'International model, global spec (ZP / MY / LL / other)',
  'เครื่องนอกมีข้อจำกัด (LL / J / CH / KH)': 'Restricted international model (LL / J / CH / KH)',
  'เครื่องนอกมีข้อจำกัด (J / KH / CH)': 'Restricted international model (J / KH / CH)',
  'ใช้งานในไทยได้ครบทุกฟังก์ชัน แต่ไม่ใช่เครื่องศูนย์ไทย': 'Fully functional in Thailand, but not a Thai-market device',
  'LL ไม่มีถาดซิม (eSIM เท่านั้น), J/KH ปิดเสียงชัตเตอร์ไม่ได้, CH ใช้ FaceTime Audio ไม่ได้ — สภาพคล่องต่ำ': 'LL has no SIM tray (eSIM only), J/KH cannot mute the camera shutter, CH has FaceTime Audio disabled — low resale liquidity',
  'J/KH ปิดเสียงชัตเตอร์ไม่ได้, CH ใช้ FaceTime Audio ไม่ได้ — สภาพคล่องต่ำ': 'J/KH cannot mute the camera shutter, CH has FaceTime Audio disabled — low resale liquidity',
  'ติดล็อกเครือข่าย / ติดสัญญา (ไทยหรือต่างประเทศ)': 'Carrier-locked or under contract (Thai or foreign carrier)',
  'ติดล็อกค่ายมือถือในไทย หรือติดสัญญา/แบล็กลิสต์จากต่างประเทศ ใช้ซิมไทยไม่ได้ตามปกติ': 'Locked to a Thai carrier, or under contract/blacklisted abroad — cannot use a Thai SIM normally',
  ...
  'เสื่อมมาก แบตหมดเร็วกว่าปกติ': 'Heavily worn; drains faster than normal',
  'เสื่อมมาก หรือขึ้นเตือน Service ใน Settings': 'Heavily worn or shows a Service alert in Settings',
  ...
  'เสื่อมตามการใช้งาน ยังใช้ได้ปกติ': 'Normal wear, still performs well',
  'เสื่อมค่อนข้างมาก เริ่มต้องชาร์จบ่อย': 'Noticeably worn, needs charging more often',
  'เสื่อมมากหรือขึ้นเตือน Service ควรเปลี่ยนแบตเตอรี่': 'Heavily worn or shows a Service alert; battery replacement recommended',
  'แบตเตอรี่ยังดีหรือเสื่อม ไม่ต้องระบุเปอร์เซ็นต์': 'Is the battery healthy or degraded? No exact percentage needed',
  'เกณฑ์รับได้ของรุ่นนี้ ไม่หักราคา': 'Acceptable range for this model; no deduction',
  'เสื่อมมาก ควรเผื่อค่าเปลี่ยนแบตเตอรี่': 'Heavily worn; budget for a battery replacement',
  'พ้นระยะประกันศูนย์แล้ว ไม่หักราคาสำหรับรุ่นนี้': 'Out of Apple warranty; no deduction for this model',
  'แบตเตอรี่ดี': 'Healthy battery',
  'สุขภาพแบต 80% ขึ้นไป ไม่ขึ้น Service': 'Battery health 80% or above with no Service alert',
  'สุขภาพแบตต่ำกว่า 80% หรือขึ้นเตือน Service': 'Battery health below 80% or shows a Service alert',
  // Mac policy tiers (mac_new / mac_mid / mac_intel / mac_imac / mac_desktop)
  'เปิดเครื่อง / การทำงานพื้นฐาน': 'Power / Basic operation',
  'เปิดติด ใช้งานได้ปกติ': 'Powers on and runs normally',
  'ดูสถานะแบตจาก การตั้งค่า > แบตเตอรี่ และ Cycle Count ใน System Report': 'Check battery status in Settings > Battery and the cycle count in System Report',
  // เกณฑ์คู่ รอบชาร์จ/แบต% (ส.ค. 2026)
  'ดูสถานะแบต + ความจุสูงสุด (Maximum Capacity) จาก การตั้งค่า > แบตเตอรี่ และ Cycle Count ใน System Report — ถ้าเข้าเกณฑ์หลายระดับ เลือกระดับที่แย่กว่า': 'Check battery status and maximum capacity in Settings > Battery, plus the cycle count in System Report — if more than one band applies, pick the worse one',
  'แบตปกติ (รอบชาร์จไม่เกิน 300 และแบต 90% ขึ้นไป)': 'Battery normal (up to 300 cycles and 90-100% health)',
  'สถานะ Normal, Cycle Count ไม่เกิน 300 และความจุสูงสุด 90-100%': 'Status Normal, cycle count up to 300, maximum capacity 90-100%',
  'รอบชาร์จเกิน 300 หรือแบต 85-89%': 'Over 300 cycles or 85-89% battery health',
  'Cycle Count 301-400 หรือความจุสูงสุด 85-89%': 'Cycle count 301-400 or maximum capacity 85-89%',
  'รอบชาร์จเกิน 400 หรือแบต 80-84%': 'Over 400 cycles or 80-84% battery health',
  'Cycle Count 401-500 หรือความจุสูงสุด 80-84%': 'Cycle count 401-500 or maximum capacity 80-84%',
  'รอบชาร์จเกิน 500 หรือแบตต่ำกว่า 80% หรือขึ้น Service Recommended': 'Over 500 cycles, below 80% health, or Service Recommended',
  'Cycle Count เกิน 500, ความจุสูงสุดต่ำกว่า 80% หรือขึ้นสถานะ Service Recommended (เข้าเกณฑ์เปลี่ยนแบต)': 'Cycle count over 500, maximum capacity below 80%, or shows Service Recommended (battery replacement due)',
  'แบตปกติ (Normal, รอบชาร์จต่ำกว่า 300)': 'Battery Normal (under 300 cycles)',
  'สถานะแบต Normal และ Cycle Count ต่ำกว่า 300': 'Battery status Normal with a cycle count under 300',
  'แบตปกติ รอบชาร์จสูง (300 ขึ้นไป)': 'Battery Normal, high cycle count (300+)',
  'สถานะแบต Normal แต่ Cycle Count 300 ขึ้นไป': 'Battery status Normal but the cycle count is 300 or higher',
  'เสื่อม / ขึ้น Service Recommended': 'Degraded / Service Recommended',
  'ขึ้นสถานะ Service Recommended หรือแบตหมดเร็วผิดปกติ': 'Shows Service Recommended or drains unusually fast',
  'แบตปกติ (Normal)': 'Battery Normal',
  'สถานะแบต Normal ใช้งานได้ตามปกติ ไม่บวม': 'Battery status Normal, works fine, no swelling',
  'รอยขีดข่วนลึก / ชั้นเคลือบจอลอก': 'Deep scratches / coating wear',
  'รอยลึกมองเห็นชัด หรือชั้นเคลือบกันสะท้อนหลุดลอกเป็นดวง': 'Clearly visible deep scratches, or the anti-reflective coating is peeling in patches',
  'สภาพตัวเครื่อง (บอดี้)': 'Body condition',
  'รอย ตำหนิ หรือความเสียหายของตัวเครื่อง': 'Marks, blemishes, or damage on the body',
  'ตัวเครื่อง/บานพับผิดรูป ฝาปิดไม่สนิท': 'Bent body/hinge, lid does not close flush',
  'ตัวเครื่องบิดงอ บานพับหลวมหรือผิดรูป ปิดฝาแล้วไม่สนิท': 'Body is bent, hinge is loose or misaligned, or the lid does not close flush',
  'ประเทศที่ซื้อ + คีย์บอร์ด': 'Country of purchase + Keyboard',
  'เครื่องศูนย์ไทยหรือเครื่องนอก และ layout ของคีย์บอร์ด': 'Thai-market or imported device, and the keyboard layout',
  'ศูนย์ไทย คีย์บอร์ดไทย': 'Thai-market, Thai keyboard',
  'เครื่องศูนย์ไทย คีย์บอร์ดสกรีนภาษาไทย': 'Official Thai-market device with a Thai-printed keyboard',
  'เครื่องนอก คีย์บอร์ดไทย': 'Imported, Thai keyboard',
  'เครื่องจากต่างประเทศ คีย์บอร์ดสกรีนภาษาไทย': 'Imported device with a Thai-printed keyboard',
  'เครื่องนอก คีย์บอร์ด US / layout อื่น': 'Imported, US or other keyboard layout',
  'เครื่องจากต่างประเทศ คีย์บอร์ดไม่มีสกรีนภาษาไทย': 'Imported device without Thai-printed keys',
  'ครบกล่อง (เครื่อง+อะแดปเตอร์+กล่อง)': 'Complete in box (device + adapter + box)',
  'กล่องตรงเครื่อง อะแดปเตอร์แท้ครบ': 'Matching box with the genuine power adapter',
  'ขาดกล่อง (มีเครื่อง+อะแดปเตอร์)': 'No box (device + adapter)',
  'มีเครื่องและอะแดปเตอร์ แต่ไม่มีกล่อง': 'Device and power adapter, no box',
  'เครื่องเปล่า (ไม่มีอะแดปเตอร์/กล่อง)': 'Device only (no adapter/box)',
  'มีเฉพาะตัวเครื่อง ไม่มีอะแดปเตอร์และกล่อง': 'Device only, without the power adapter or box',
